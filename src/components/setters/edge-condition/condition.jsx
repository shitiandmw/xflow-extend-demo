import { Form, Radio, Card, Button } from 'antd'
...
const EdgeCondition = forwardRef(({ value }, ref) => {
    ...
    return <Form form={formRef}  onValuesChange={handleFormChange}  initialValues={ defaultValue}>
        <div className="flex flex-col gap-y-4">
            ...
            <Form.List name="conditionGroups">
                {(fields, { add, remove }) => {
                   return <EdgeConditionGroup  fields={fields} add={add} remove={remove} key={nanoid()} />
                }}
            </Form.List>
